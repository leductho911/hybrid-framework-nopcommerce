...
public class BasePage {
	...
	public void closeAllTabWithoutParent(WebDriver driver, String currentWindowID) {
	...
	public void selectItemInCustomDropdown(WebDriver driver, String parentXpath, String allItemsXPath,
		...
		List<WebElement> allItems = explicitWait
				.until(ExpectedConditions.presenceOfAllElementsLocatedBy(getByXpath(allItemsXPath)));
	...
	public void getElementsSize(WebDriver driver, String xpathLocator) {
	...
	public void waitForAlertPresence(WebDriver driver, String xpathLocator) {
		WebDriverWait explicitWait = new WebDriverWait(driver, longTimeout);
