...
public class ExtentManager {
	...
	public synchronized static ExtentReports createExtentReports() {
		...
		extentReports.setSystemInfo("Company", "Company name here");
		extentReports.setSystemInfo("Project", "NopCommerce project");
		extentReports.setSystemInfo("Team", "Your team name");
